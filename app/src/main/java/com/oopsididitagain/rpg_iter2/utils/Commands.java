...
public class Commands {
    ...
    public static final int MOVE_NORTH = 'w';
    public static final int MOVE_SOUTH = 'x';
    public static final int MOVE_EAST = 'd';
    public static final int MOVE_WEST = 'a';
    public static final int MOVE_NORTH_EAST = 'e';
