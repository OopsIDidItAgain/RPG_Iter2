 ...
 * and to avoid encumberance.So that the avatar
 * doesn't have methods that it won't need. 
 * 
 * This can have all the skills because its handling the skills for 
 * all entities.
 * 
 * We could subclass avatar out into smasher sneak and summoner, as well.
 * 
 * but essentially I imagined the view displaying the active 
 * skills that the avatar can use based on their occupation,
 * 
 * GameController:
 * takeSneakInput();
 * takeSmasherInput();
 ...
 * send the avatar calling the skill and the object thats being affected into here.
 * 
 */
